use super::*;
use constants::{
    currency::{AMAS_CENTS, AMAS_UNITS},
...
parameter_types! {
    ...
    pub const SignedRewardBase: Balance = 1 * AMAS_UNITS;
    pub const SignedDepositBase: Balance = 1 * AMAS_UNITS;
    pub const SignedDepositByte: Balance = 1 * AMAS_CENTS;
