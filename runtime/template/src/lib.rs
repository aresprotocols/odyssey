...
pub use constants::types::{AccountId, AuraId, Balance, BlockNumber, Hash, Header, Index, Signature};
...
pub type AssetsForceOrigin =
	EnsureOneOf<AccountId, EnsureRoot<AccountId>, EnsureXcm<IsMajorityOfBody<DotLocation, ExecutiveBody>>>;
...
impl cumulus_pallet_parachain_system::CheckInherents<
	Block
> for CheckInherents {
	fn check_inherents(
		block: &Block,
