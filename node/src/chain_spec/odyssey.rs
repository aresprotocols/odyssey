...
pub fn odyssey_session_keys(aura: AuraId, ares: AresId) -> SessionKeys {
...
fn odyssey_genesis(
	...
	let elections_stash: OdysseyBalance = endowment / 1000;
			...
			keys: initial_authorities
				...
				.map(|(stash, controller, aura, ares)| {
					(
						stash.clone(),
						stash.clone(),
						odyssey_session_keys(aura.clone(), ares.clone()),
					)
				})
				.collect::<Vec<_>>(),
		},
